...
Let's add models for image generation, video generation, TTS, and realtime voice.

Start by looking at https://platform.openai.com/docs/models specialized models (click into each one).

I also took some screenshots from https://ai.google.dev/gemini-api/docs/models showing relevant models.
